...
import "Geldahr.LUI.Assets.assets_entry"
...
function AssetsWindow:Constructor()
    ...
    self.stack_items_cb = Turbine.UI.Lotro.CheckBox()
    ...
    self.storage_label = Turbine.UI.TextBox()
    ...
    self.summary_text = Turbine.UI.Label()
    ...
    self.group_label = Turbine.UI.TextBox()
