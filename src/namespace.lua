...
LUI.integrations = ensure(LUI, "integrations")
LUI.integrations.Registry = ensure(LUI.integrations, "Registry")
LUI.integrations.Registry.by_key = ensure(LUI.integrations.Registry, "by_key")
LUI.integrations.Registry.order = ensure(LUI.integrations.Registry, "order")
LUI.integrations.Potential = ensure(LUI.integrations, "Potential")
LUI.integrations.Potential.by_key = ensure(LUI.integrations.Potential, "by_key")
LUI.integrations.Potential.order = ensure(LUI.integrations.Potential, "order")
...
LUI.Runtime.Windows.integrations = ensure(LUI.Runtime.Windows, "integrations")
