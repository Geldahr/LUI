...
local DEFAULTS = {
    ...
    SETTINGS_TITLE_FONT_NAME = "BookAntiquaBold",
    SETTINGS_TITLE_FONT_SIZE = 18,
    FIRST_RUN_TITLE_FONT_NAME = "BookAntiqua",
    FIRST_RUN_TITLE_FONT_SIZE = 22,
    TAB_FONT_NAME = "Verdana",
    TAB_FONT_SIZE = 12,
    HELP_FONT_NAME = "Verdana",
    HELP_FONT_SIZE = 10,
...
local FALLBACKS = {
    ...
    FIRST_RUN_TITLE_FONT_NAME = "SETTINGS_TITLE_FONT_NAME",
    FIRST_RUN_TITLE_FONT_SIZE = "SETTINGS_TITLE_FONT_SIZE",
