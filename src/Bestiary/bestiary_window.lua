...
function DropChip:apply_settings(chest, matched)
    ...
    self.label:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
...
function BestiaryRow:apply_settings()
    ...
    local meta_font = _scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE)
    local taxonomy_font = _scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE)
...
function BestiaryWindow:Constructor()
    ...
    self.order_label:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    ...
    self.genus_label:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
...
function BestiaryWindow:apply_settings()
    ...
    local button_font = _scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE)
