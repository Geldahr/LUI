...
function CraftingRecipeRow:set_scale(scale)
    ...
    self.subtitle:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.status_label:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.favorite_button:set_scale(1)
...
function CraftingIngredientRow:set_scale(scale)
    ...
    self.detail:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.source_hint:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.amount:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.bestiary_button:set_scale(1)
    _apply_bestiary_icon(self.bestiary_button)
end
...
function CraftingPlanRow:set_scale(scale)
    ...
    self.remove_button:set_font(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
end
...
function CraftingWindow:_ensure_source_breakdown_hint_rows(count)
    ...
    while #self.source_breakdown_hint_rows < count do
        ...
        row.source:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
        ...
        row.quantity:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
...
function CraftingWindow:apply_settings()
    ...
    self.clear_button:set_font(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.favorite_filter_button:set_scale(1)
    self.scope_label:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.scope_dropdown:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.scope_dropdown:set_scale(_G.settings.global.scale)
    self.profession_label:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.profession_dropdown:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.profession_dropdown:set_scale(_G.settings.global.scale)
    self.rank_label:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.rank_dropdown:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.rank_dropdown:set_scale(_G.settings.global.scale)
    self.availability_label:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.availability_dropdown:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.availability_dropdown:set_scale(_G.settings.global.scale)
    self.level_label:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.level_min_box:SetFont(_scaled_font(Style.CONTROL_FONT_NAME, Style.CONTROL_FONT_SIZE - 1))
    self.level_dash_label:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.level_max_box:SetFont(_scaled_font(Style.CONTROL_FONT_NAME, Style.CONTROL_FONT_SIZE - 1))
    self.recipe_page_label:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))

    self.recipe_empty:SetFont(_scaled_font(Style.CONTROL_FONT_NAME, Style.CONTROL_FONT_SIZE - 1))
    self.right_tab_bar:set_font(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    ...
    self.detail_meta:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    ...
    self.plan_label:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    ...
    self.ingredients_title:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.detail_empty:SetFont(_scaled_font(Style.CONTROL_FONT_NAME, Style.CONTROL_FONT_SIZE - 1))
    self.queue_title:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    ...
    self.plan_title:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.plan_track_button:set_font(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.plan_revert_button:set_font(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.plan_clear_button:set_font(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.missing_title:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    self.missing_bestiary_button:set_scale(1)
    _apply_bestiary_icon(self.missing_bestiary_button)
    self.plan_empty:SetFont(_scaled_font(Style.CONTROL_FONT_NAME, Style.CONTROL_FONT_SIZE - 1))
    self.loading_text:SetFont(_scaled_font(Style.HELP_FONT_NAME, Style.HELP_FONT_SIZE))
    if self.source_breakdown_hint ~= nil then
        self.source_breakdown_hint:set_scale(_G.settings.global.scale)
    end
